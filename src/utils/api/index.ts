...
export const login = (email: string, password: string) => {
  return fetch(myRequest(`${baseUrl}/user/login`, 'POST'), {
...
export const createAnUser = (user: User) => {
  return fetch(myRequest(`${baseUrl}/user/register`, 'POST'), {
...
export const getUser = (id: string): Promise<User> => {
  return fetch(myRequest(`${baseUrl}/user/${id}`, 'GET'))
    .then((response) =>
...
export const getAccount = (id: string, token: string): Promise<UserAccount> => {
  ...
  return fetch(myRequest(`${baseUrl}/account/users/${id}/accounts`, 'GET', token), {})
    .then((response) => {
      if (response.ok) {
...
export const getAccounts = (): Promise<UserAccount[]> => {
  ...
  return fetch(myRequest(`${baseUrl}/account/accounts`, 'GET'))
    .then((response) => 
      response.ok ? response.json() : rejectPromise(response)
    )
    .catch((err) => {
...
export const updateAccount = (
  ...
  return fetch(myRequest(`${baseUrl}/account/users/${id}/accounts/1`, 'PATCH', token), {
    body: JSON.stringify(data),
  })
    .then((response) =>
      response.ok ? response.json() : rejectPromise(response)
...
export const getUserActivities = (
  ...
  return fetch(
    myRequest(
      `${baseUrl}/account/users/${userId}/activities${limit ? `?_limit=${limit}` : ''}`,
      'GET',
      token
    )
  )
...
export const getUserActivity = (
  ...
  return fetch(
    myRequest(
      `${baseUrl}/account/users/${userId}/activities/${activityId}`,
      'GET',
      token
    )
  )
...
export const getUserCards = (
  ...
  return fetch(myRequest(`${baseUrl}/account/users/${userId}/cards`, 'GET', token))
    .then((response) => {
      if (response.ok) {
        return response.json();
      }
...
export const deleteUserCard = (
  ...
  return fetch(
    myRequest(`${baseUrl}/account/users/${userId}/cards/${cardId}`, 'DELETE', token)
  )
    .then((response) => {
      if (response.ok) {
        return response.json();
...
export const createUserCard = (
  ...
  return fetch(myRequest(`${baseUrl}/account/users/${userId}/cards`, 'POST', token), {
...
export const createDepositActivity = (
  ...
  return fetch(
    myRequest(`${baseUrl}/account/users/${userId}/activities`, 'POST', token),
    {
